Ext.ux.grid.filter.DateFilter = Ext.extend(Ext.ux.grid.filter.Filter, {
	...
	init: function(){
		...
		var dates = this.dates = {
			'before': new Ext.menu.CheckItem({text: "Prima del", menu: new Ext.menu.DateMenu(opts)}),
			'after':  new Ext.menu.CheckItem({text: "Dopo il", menu: new Ext.menu.DateMenu(opts)}),
			'on':     new Ext.menu.CheckItem({text: "In data", menu: new Ext.menu.DateMenu(opts)})};
